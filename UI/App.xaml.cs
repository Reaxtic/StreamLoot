...
namespace UI
{
    ...
    public partial class App : System.Windows.Application
    {
        ...
        private const string MutexName = @"Global\StreamLoot_Instance";
        ...
        private void OnUnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            if (e.ExceptionObject is Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"A critical error has happened, please contact Reaxtic to resolve this issue.\n\nInclude the following Error Message: {ex.Message}", "Critical Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
}